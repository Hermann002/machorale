...
MIDDLEWARE += [
    # ...
    "silk.middleware.SilkyMiddleware",  # Doit être placé APRÈS les middlewares d'authentification
    # ...
]

# Configuration spécifique pour ASGI
SILKY_PYTHON_PROFILER = True
SILKY_AUTHENTICATION = True  # Restreint l'accès à /silk aux utilisateurs connectés
