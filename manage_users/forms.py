...
class UserRegisterForm(forms.ModelForm):
    confirm_password = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": f"{input_class_password}", "placeholder": "••••••••"}
        ),
...
class UserLoginForm(forms.Form):
    username = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": f"{input_class}", "placeholder": "Username"}
        ),
        label=_("Username"),
    )
    password = forms.CharField(
        max_length=100,
        widget=forms.PasswordInput(
            attrs={"class": f"{input_class}", "placeholder": "Password"}
        ),
        label=_("Password"),
    )
...
class ResetPasswordRequestForm(forms.Form):
    email = forms.EmailField(
        widget=forms.EmailInput(
            attrs={"class": f"{input_class}", "placeholder": "Enter your email"}
        ),
        label=_("Email"),
    )
...
class ProfileForm(forms.Form):
    ...
    contact = forms.CharField(
        ...
        label=_("Téléphone"),
        widget=forms.TextInput(
            attrs={"class": FIELD_CLASS, "placeholder": "+237 6XX XXX XXX"}
        ),
    )
    ...
    profession_c = forms.ChoiceField(
        required=False,
        choices=PROFESSION_CHOICES,
        label=_("Profession"),
        widget=forms.Select(attrs={"class": FIELD_CLASS}),
    )
    profession_o = forms.CharField(
        max_length=100,
        required=False,
